...
export default function GenerateModal({ openGenerateModal, setOpenGenerateModal }) {
    ...
    return (
        <div>
            <h1>GenerateModal</h1>
            <Modal show={openGenerateModal} onClose={() => setOpenGenerateModal(false)}>
            ...
            <div onClick={() => setOpenGenerateModal(false)}>click to close</div>
            </Modal>
        </div>
    );
}