...
export default function StudyPortal({ setOpenGenerateModal, setOpenNoteModal }) {
    ...
    return (
        ...
        <div class="mb-4"></div>
          <div onClick={handleGenerateClick} class="card">
            <div class="header">
                <img alt="generate" src="https://assets-global.website-files.com/640e63e70c1c77711e52d68b/64215fa40c33f7d09cdd71ad_Highlight%2003.png"/>
            </div>
